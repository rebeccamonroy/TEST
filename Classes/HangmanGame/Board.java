...
public class Board {
    ...
    private int wordOption = 0;

    public void showWordBankCategory() {
        ...
        try (
            ...
            switch (wordOption) {
                case 0:
                    wordSelected = new File("C:/Users/rebecca.monroy01/Desktop/HangmanGame/WordBank/easyWords.txt");
                    System.out.println("You have selected easy words");
                    break;
                case 1:
                    wordSelected = new File(
                            "C:/Users/rebecca.monroy01/Desktop/HangmanGame/WordBank/difficultWords.txt");
